...
- Pivoted from `claude` to `claude-2` on 2026-05-07. claude-2 forked from main tip `f8b6360`. **Sprints 3-12 ratified — original 12-sprint roadmap closed. Sprint 13 reverted (0pp gain). Sprint 13.5 wrapped (bench infra + state audit; 9/9 Sprint 14 readiness gates green).**
