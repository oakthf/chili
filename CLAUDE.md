...
- [`docs/sync/`](docs/sync/) — live: `mdata_chili_2026-05-19_0.8.7_delivery.md` (active 0.8.7 handoff) + `decisions-needed.md` (open: empty) + `ideas.md` (8 entries) + `upstream_handle_lock_proposal_2026-05-14.md` (open upstream-author opinion request, handle write-lock contention). Swept to `docs/history/sync/` 2026-05-19: `mdata_push_model_proposal_2026-05-17.md` (satisfied → ADR-0006), `mdata_chili_2026-05-18_main_merge_signoff.md` (Sprint-20 closed), `mdata_chili_2026-05-16_0.8.6_delivery.md` (superseded by 0.8.7); earlier 0.8.1–0.8.5 deliveries + `load_par_df_state_audit` already there.
