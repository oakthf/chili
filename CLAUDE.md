...
- mdata delivery: **chili-sauce 0.8.4 wheel** at `dist/chili_sauce-0.8.4-cp310-abi3-macosx_11_0_arm64.whl` (Sprint 16 — adds flush_tplog + add_at_time + pepper :: disambiguation) + handoff doc `docs/sync/mdata_chili_2026-05-13_0.8.4_delivery.md`. 0.8.3 still at `dist/chili_sauce-0.8.3-...whl` for byte-equivalence baseline reference; all earlier delivery docs moved to `docs/history/sync/` (0.8.1 / 0.8.2 / 0.8.3).
