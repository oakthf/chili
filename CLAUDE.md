...
- Test count on claude-2 (post-Sprint-18): **182 Rust** (`cargo test --workspace --exclude chili-py`; +10 Sprint 18 `roll_tick_test.rs`: 3 red-first teeth + 7 roll_tick) + **94 chili-py pytest passing + 0 xfailed** (`uv run pytest`; +7 Sprint 18 `test_roll_tick.py`).
