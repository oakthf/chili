...
| 4 | additive feature port wave 2 — chili-py clippy unblock + ADR 0002 (`engine.eval(lazy=True)`) + bench rebaseline rows | In progress 2026-05-07 (autonomous run) | [`sprint_4_dispatch_brief_2026-05-07.md`](sprint_4_dispatch_brief_2026-05-07.md) | — | — |
