...
| 8 | perf-pass-1 — Sprint 7 R1/R2/R3 fixes (parse_cache reclaim + load_multitable profile + eval bench parser fix + A/B rows fill) | In progress 2026-05-08 (autonomous run) | [`sprint_8_dispatch_brief_2026-05-08.md`](sprint_8_dispatch_brief_2026-05-08.md) | — | — |
