...
| 13 | `load_par_df` hot path optimization — P1.1 batch schema reads + P1.3 qualified-name interning + A.2.6 `build_qualified_name` allocations + A.2.8 `dir_has_partition_files` redundant traversals + A.2.3 polars feature-flag audit. Recovers ≥ half of Sprint 7 Part B's +22.8% `load_multitable_5x200p` regression. | In progress | [`sprint_13_dispatch_brief_2026-05-08.md`](sprint_13_dispatch_brief_2026-05-08.md) | (post-sprint) | (post-sprint) |
