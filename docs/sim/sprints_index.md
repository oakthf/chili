...
| 13.5 | Bench infrastructure + state audit (pre-Sprint-14 measurement) — NEW `tests/bench_concurrent.py` + NEW `categorical_eval.rs` + baseline capture vs 0.8.2 wheel + concurrent profile (halt threshold: GIL hold ≥ 40% of wall time) + `load_par_df_state_audit.md`. NO chili source changes. Sprint 14 readiness gate. | In progress | [`sprint_13.5_dispatch_brief_2026-05-09.md`](sprint_13.5_dispatch_brief_2026-05-09.md) | (post-sprint) | (post-sprint) |
