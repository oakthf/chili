...
| **16 — Broker bindings (WL 1.1)** | **NEXT SESSION** — deferred to fresh session for focused implementation. ~500 LOC Rust + PyO3 callback mechanism. | **pre-verify parity test vs unix** → drop `artifacts/broker_parity_unix_status.md` | **DONE 2026-04-12**: unix parity 7/7 pass + 2 xfail (EOD, replay). ABCs frozen. Status at `artifacts/broker_parity_unix_status.md`. Q1-Q12 sort_columns rerun pending chili-py build. |
