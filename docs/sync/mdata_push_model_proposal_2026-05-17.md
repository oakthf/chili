...
| **Q4** kill-9 durability | **Confirmed** — per-drain-ack cursor; loss recovered via D-3 replay; = mdata PRD §5.1. No disk-backed queue. | ✅ Accepted. D-1 acceptance (c) = recovered-via-D3-replay, not in-flight-queue durability. |
